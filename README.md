...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-nvtx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-nvtx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-nvtx cuda-nvtx-dev
# for installing globally
pixi global install cuda-nvtx cuda-nvtx-dev
```
...
It is possible to list all of the versions of `cuda-nvtx` available on your platform:
...
```
pixi search cuda-nvtx --channel conda-forge
```
